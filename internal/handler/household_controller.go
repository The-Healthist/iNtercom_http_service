...
func NewHouseholdController(ctx *gin.Context, container *service.ServiceContainer) *HouseholdController {
...
func HandleHouseholdFunc(container *service.ServiceContainer, method string) gin.HandlerFunc {
...
func (c *HouseholdController) GetHousehold() {
	...
	if err != nil {
		errcode.ParamError(c.Ctx, "无效的户号ID")
		return
	}
	...
	if err != nil {
		errcode.NotFound(c.Ctx, "户号不存在: "+err.Error())
		return
	}

	errcode.Success(c.Ctx, household)
}
...
func (c *HouseholdController) CreateHousehold() {
	...
	if err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrBind, "关联的楼号不存在: "+err.Error(), nil)
		return
	}

	if err := householdService.CreateHousehold(household); err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "创建户号失败: "+err.Error(), nil)
		return
	}
...
func (c *HouseholdController) UpdateHousehold() {
	...
	if err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "更新户号失败: "+err.Error(), nil)
		return
	}
...
func (c *HouseholdController) DeleteHousehold() {
	...
	if err := householdService.DeleteHousehold(uint(householdID)); err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "删除户号失败: "+err.Error(), nil)
		return
	}
...
func (c *HouseholdController) GetHouseholdDevices() {
	...
	if err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "获取户号关联设备失败: "+err.Error(), nil)
		return
	}
...
func (c *HouseholdController) GetHouseholdResidents() {
	...
	if err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "获取户号下居民失败: "+err.Error(), nil)
		return
	}

	errcode.Success(c.Ctx, residents)
}
...
func (c *HouseholdController) AssociateHouseholdWithDevice() {
	...
	if err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrBind, "设备不存在: "+err.Error(), nil)
		return
	}

	if err := householdService.AssociateHouseholdWithDevice(uint(householdID), req.DeviceID); err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "关联户号与设备失败: "+err.Error(), nil)
		return
	}
...
func (c *HouseholdController) RemoveHouseholdDeviceAssociation() {
	...
	if err := householdService.RemoveHouseholdDeviceAssociation(uint(householdID), uint(deviceID)); err != nil {
		errcode.FailWithMessage(c.Ctx, errcode.ErrDatabase, "解除户号与设备关联失败: "+err.Error(), nil)
		return
	}
