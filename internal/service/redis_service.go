...
type InterfaceRedisService interface {
	...
	GetCallRecordByID(id string) (*model.CallRecord, error)
	CacheCallRecord(record *model.CallRecord, expiration time.Duration) error
}
...
func (s *RedisService) GetCallRecordByID(id string) (*model.CallRecord, error) {
...
func (s *RedisService) CacheCallRecord(record *model.CallRecord, expiration time.Duration) error {
