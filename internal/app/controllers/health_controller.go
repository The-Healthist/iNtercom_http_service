...
func NewHealthController(ctx *gin.Context, container *container.ServiceContainer) *HealthController {
...
func HandleHealthFunc(container *container.ServiceContainer, method string) gin.HandlerFunc {
