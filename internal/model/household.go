...
type Household struct {
	BaseModel
	HouseholdNumber string `gorm:"type:varchar(50);not null;index:idx_household_number" json:"household_number"`    // 户号编号，如"1-1-101"
	...
	BuildingID      uint   `gorm:"index:idx_building_id" json:"building_id"`                                        // 关联的楼号ID
